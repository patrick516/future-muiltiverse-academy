...
const ITEM_ID = "fmv-sales-leader";

const SalesLeaderPage: React.FC = () => {
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <section className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="p-4 bg-white border rounded-lg">
              <h3 className="font-semibold">Leadership Tracks</h3>
              <ul className="pl-5 mt-2 space-y-1 text-sm list-disc">
                <li>Team Formation</li>
                <li>Coaching & Mentoring</li>
                <li>Performance Playbooks</li>
              </ul>
            </div>
            <div className="p-4 bg-white border rounded-lg">
              <h3 className="font-semibold">KPIs & Dashboards</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Templates and examples for weekly reviews and growth metrics.
              </p>
            </div>
            <div className="p-4 bg-white border rounded-lg">
...
export default SalesLeaderPage;
